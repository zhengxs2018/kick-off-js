import { isMloMessageEvent, type MloObject, type MloSnapshot } from '@zhengxs/mlo';
  ...
  return (
    <div className="min-h-screen bg-zinc-50/50 font-sans text-zinc-900 selection:bg-blue-100">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-500">Snapshot: {formatTime(data.timestamp)}</p>
              </div>
            </div>
      ...
      <main className="mx-auto max-w-7xl px-6 py-8 space-y-8">
        ...
        {/* Data Table */}
        <MloTable data={filteredItems} onLink={handleLinkClick} onLog={handleLog} />
      </main>
