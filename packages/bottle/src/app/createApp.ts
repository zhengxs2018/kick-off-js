...
export function createApp(config?: AppConfig) {
  ...
  function createContext(req: IncomingMessage, res: ServerResponse<IncomingMessage>) {
  ...
  function listen(port?: number, hostname?: string, listeningListener?: () => void): Server;
  function listen(port?: number, backlog?: number, listeningListener?: () => void): Server;
  function listen(port?: number, listeningListener?: () => void): Server;
  function listen(path: string, backlog?: number, listeningListener?: () => void): Server;
  function listen(path: string, listeningListener?: () => void): Server;
  function listen(options: ListenOptions, listeningListener?: () => void): Server;
  function listen(handle: any, backlog?: number, listeningListener?: () => void): Server;
